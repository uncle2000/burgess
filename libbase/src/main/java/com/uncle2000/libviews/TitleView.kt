...
import com.uncle2000.libbase.databinding.ViewTitleBinding
...
class TitleView @JvmOverloads constructor(
    ...
    var right2TextColor = ContextCompat.getColor(context,
        R.color.defaults_other_title_text_color
    )
    var titleTextColor = ContextCompat.getColor(context, R.color.defaults_other_title_text_color)
    var subTitleTextColor = ContextCompat.getColor(context,
        R.color.defaults_sub_title_text_color
    )
            ...
            binding.apply {
                ...
                when (colorMode) {
                    TYPE_WHITE -> {
                        ...
                        leftDrawable = ContextCompat.getDrawable(context,
                            R.drawable.svg_arrow_left_white
                        )
                        leftTextColor = ContextCompat.getColor(context,
                            R.color.defaults_white_text_color
                        )
                        rightTextColor = ContextCompat.getColor(context,
                            R.color.defaults_white_text_color
                        )
                        right2TextColor = ContextCompat.getColor(context,
                            R.color.defaults_white_text_color
                        )
                        titleTextColor = ContextCompat.getColor(context,
                            R.color.defaults_white_text_color
                        )
                        subTitleTextColor = ContextCompat.getColor(context,
                            R.color.defaults_white_text_color
                        )
                    }
                    TYPE_BLACK -> {
                        ...
                        leftDrawable = ContextCompat.getDrawable(context,
                            R.drawable.svg_arrow_left_black
                        )
                        leftTextColor = ContextCompat.getColor(context,
                            R.color.defaults_title_text_color
                        )
                        rightTextColor = ContextCompat.getColor(context,
                            R.color.defaults_other_title_text_color
                        )
