...
import com.uncle2000.libbase.BR
import com.uncle2000.libbase.OnItemClickListener
import com.uncle2000.libbase.OnItemLongClickListener
...
//    }
    ...
    final override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Vh<T> {
        return when (viewType) {
            PLACEHOLDER -> PlaceholderVh(phView)
    ...
    open fun onCreateContentViewHolder(parent: ViewGroup, viewType: Int): ContentVh<T> {
        return ContentVh(DataBindingUtil.inflate<ViewDataBinding>(LayoutInflater.from(context), getLayoutId(viewType), parent, false))
    }
