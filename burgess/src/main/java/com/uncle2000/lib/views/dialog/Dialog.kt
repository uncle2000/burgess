...
import com.uncle2000.lib.databinding.DialogFragmentNewBinding
...
open class Dialog : DialogFragment(), DialogInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val binding: DialogFragmentNewBinding = DataBindingUtil.inflate(inflater, R.layout.dialog_fragment_new, null, false)
    ...
    private fun initMessage(p: DialogParameters) {
        ...
        if (TextUtils.isEmpty(p.title)) { // 无title c7f4
            ...
            scrollView?.post {
                ...
                scrollView?.layoutParams?.height = Math.min(tvMessage?.height
                ...
                if (tvMessage?.height ?: MAX_HEIGHT.toInt() > maxHeightPx) {
                    ...
                    scrollView?.setPadding(tvMessage?.paddingLeft ?: 0,
