...
//        type = a.getAny(R.styleable.RoundImageView_type, TYPE_CIRCLE);// 默认为Circle
//
//        a.recycle();
//    }
//
...
//
//
//        RectF mBitmapRect = new RectF(0, 0, bmp.getWidth(), bmp.getHeight());
...
//            this.type = bundle.getAny(STATE_TYPE);
//            this.mBorderRadius = bundle.getAny(STATE_BORDER_RADIUS);
//        } else {
